...
Consult the [installation manual](https://os-cau.github.io/cau-repl/installation/) for details, including ways to start the REPL if you can't use a Java agent.
